...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: Table is empty",c.moveToFirst());
        TestUtilities.validateCurrentRecord("Record not validated", c, contentValues);
        assertFalse("More than one row inserted",c.moveToNext());
        c.close();
        db.close();
    }
