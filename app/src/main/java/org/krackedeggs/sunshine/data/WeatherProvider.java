 ...
 */
package org.krackedeggs.sunshine.data;
...
import org.krackedeggs.sunshine.data.WeatherDbHelper;
...
public class WeatherProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        //db.close(); //TODO: check db.close everywhere
        return returnUri;
    }
...
//                if ( rowsDeleted == 0 )
//                    throw new android.database.SQLException("Failed to delete row(s)");
                break;
            }
            case LOCATION: {
...
//                    throw new android.database.SQLException("Failed to delete row(s)");
        ...
        if (rowsDeleted != 0 || selection == null) { // selection = null will delete all rows
            getContext().getContentResolver().notifyChange(uri, null);
        }
